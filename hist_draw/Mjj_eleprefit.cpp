...
void Mjj_eleprefit(){
 ...
 cs -> Print("Mjj_elepretfit.pdf["); // Make blank page in pdf file

 auto hs = new THStack("hs","Mjj_prefit_ele"); // Object used to plot histograms stacked on one another
  ...
  cs -> Update();
  cs -> Print("Mjj_elepretfit.pdf");
  cs -> Print("Mjj_elepretfit.pdf]"); // Need to call this agani to tell the PDF that this was the last page ( thats the "]" )
  cs -> Clear();
