...
TFile f1(outfile,"RECREATE");
 ...
 QArrayProcessor dataproc("Data Processor","Data Processor");
  ...
  dataproc.GetProc("Selector").AddIVar("dPhijj","tree://Ntuples/Data_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc.GetProc("Selector").AddIVar("dYjj","tree://Ntuples/Data_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc.GetProc("Selector").AddIVar("j1Pt","tree://Ntuples/Data_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc.GetProc("Selector").AddIVar("l1Pt","tree://Ntuples/Data_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc.GetProc("Selector").AddIVar("Mjj","tree://Ntuples/Data_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc.GetProc("Selector").AddIVar("Ptjj","tree://Ntuples/Data_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc.GetProc("Selector").AddIVar("passReco","tree://Ntuples/Data_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc.GetProc("Selector").AddIVar("cut","tree://Ntuples/Data_All_Years_ele_v23.5.root:CollectionTree_NOM");
  //dataproc.GetProc("Selector").AddIVar("passSR","tree://Ntuples/Data_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc.GetProc("Selector").AddIVar("nGapJets","tree://Ntuples/Data_All_Years_ele_v23.5.root:CollectionTree_NOM");
  ...
  dataproc.GetProc("Data Fill").AddIVar("dPhijj","tree://Ntuples/Data_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc.GetProc("Data Fill").AddIVar("dYjj","tree://Ntuples/Data_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc.GetProc("Data Fill").AddIVar("j1Pt","tree://Ntuples/Data_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc.GetProc("Data Fill").AddIVar("l1Pt","tree://Ntuples/Data_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc.GetProc("Data Fill").AddIVar("Mjj","tree://Ntuples/Data_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc.GetProc("Data Fill").AddIVar("Ptjj","tree://Ntuples/Data_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc.GetProc("Data Fill").AddIVar("l1Cent","tree://Ntuples/Data_All_Years_ele_v23.5.root:CollectionTree_NOM");
  ...
  dataproc2.GetProc("EW_Selector").AddIVar("dPhijj","tree://Ntuples/EW_Pow_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc2.GetProc("EW_Selector").AddIVar("dYjj","tree://Ntuples/EW_Pow_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc2.GetProc("EW_Selector").AddIVar("j1Pt","tree://Ntuples/EW_Pow_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc2.GetProc("EW_Selector").AddIVar("l1Pt","tree://Ntuples/EW_Pow_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc2.GetProc("EW_Selector").AddIVar("Mjj","tree://Ntuples/EW_Pow_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc2.GetProc("EW_Selector").AddIVar("Ptjj","tree://Ntuples/EW_Pow_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc2.GetProc("EW_Selector").AddIVar("passReco","tree://Ntuples/EW_Pow_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc2.GetProc("EW_Selector").AddIVar("cut","tree://Ntuples/EW_Pow_All_Years_ele_v23.5.root:CollectionTree_NOM");
  //dataproc2.GetProc("EW_Selector").AddIVar("passSR","tree://Ntuples/EW_Pow_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc2.GetProc("EW_Selector").AddIVar("nGapJets","tree://Ntuples/EW_Pow_All_Years_ele_v23.5.root:CollectionTree_NOM");


  dataproc2.AddPSProc("EW Fill","EW Fill", MC_fill, NULL,kTRUE);
  //Get the TTree Branches
  dataproc2.GetProc("EW Fill").AddIVar("dPhijj","tree://Ntuples/EW_Pow_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc2.GetProc("EW Fill").AddIVar("dYjj","tree://Ntuples/EW_Pow_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc2.GetProc("EW Fill").AddIVar("j1Pt","tree://Ntuples/EW_Pow_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc2.GetProc("EW Fill").AddIVar("l1Pt","tree://Ntuples/EW_Pow_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc2.GetProc("EW Fill").AddIVar("Mjj","tree://Ntuples/EW_Pow_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc2.GetProc("EW Fill").AddIVar("Ptjj","tree://Ntuples/EW_Pow_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc2.GetProc("EW Fill").AddIVar("l1Cent","tree://Ntuples/EW_Pow_All_Years_ele_v23.5.root:CollectionTree_NOM"); 
  dataproc2.GetProc("EW Fill").AddIVar("Lumi","tree://Ntuples/EW_Pow_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc2.GetProc("EW Fill").AddIVar("finalWeight","tree://Ntuples/EW_Pow_All_Years_ele_v23.5.root:CollectionTree_NOM");
  //dataproc2.GetProc("EW Fill").AddIVar("passSR","tree://Ntuples/EW_Pow_All_Years_ele_v23.5.root:CollectionTree_NOM");
...
QHNF_D* sr_ew6d = new QHNF_D("EW_7D", "EW_7D", 7);
  ...
  dataproc3.GetProc("QCD_Selector").AddIVar("dPhijj","tree://Ntuples/QCD_Wjets_Powheg_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc3.GetProc("QCD_Selector").AddIVar("dYjj","tree://Ntuples/QCD_Wjets_Powheg_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc3.GetProc("QCD_Selector").AddIVar("j1Pt","tree://Ntuples/QCD_Wjets_Powheg_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc3.GetProc("QCD_Selector").AddIVar("l1Pt","tree://Ntuples/QCD_Wjets_Powheg_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc3.GetProc("QCD_Selector").AddIVar("Mjj","tree://Ntuples/QCD_Wjets_Powheg_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc3.GetProc("QCD_Selector").AddIVar("Ptjj","tree://Ntuples/QCD_Wjets_Powheg_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc3.GetProc("QCD_Selector").AddIVar("passReco","tree://Ntuples/QCD_Wjets_Powheg_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc3.GetProc("QCD_Selector").AddIVar("cut","tree://Ntuples/QCD_Wjets_Powheg_All_Years_ele_v23.5.root:CollectionTree_NOM");
  //dataproc3.GetProc("QCD_Selector").AddIVar("passSR","tree://Ntuples/QCD_Wjets_Powheg_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc3.GetProc("QCD_Selector").AddIVar("nGapJets","tree://Ntuples/QCD_Wjets_Powheg_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc3.GetProc("QCD_Selector").AddIVar("finalWeight","tree://Ntuples/QCD_Wjets_Powheg_All_Years_ele_v23.5.root:CollectionTree_NOM");

  dataproc3.AddPSProc("QCD Fill","QCD Fill", MC_fill, NULL,kTRUE);
  //Get the TTree Branches
  dataproc3.GetProc("QCD Fill").AddIVar("dPhijj","tree://Ntuples/QCD_Wjets_Powheg_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc3.GetProc("QCD Fill").AddIVar("dYjj","tree://Ntuples/QCD_Wjets_Powheg_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc3.GetProc("QCD Fill").AddIVar("j1Pt","tree://Ntuples/QCD_Wjets_Powheg_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc3.GetProc("QCD Fill").AddIVar("l1Pt","tree://Ntuples/QCD_Wjets_Powheg_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc3.GetProc("QCD Fill").AddIVar("Mjj","tree://Ntuples/QCD_Wjets_Powheg_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc3.GetProc("QCD Fill").AddIVar("Ptjj","tree://Ntuples/QCD_Wjets_Powheg_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc3.GetProc("QCD Fill").AddIVar("l1Cent","tree://Ntuples/QCD_Wjets_Powheg_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc3.GetProc("QCD Fill").AddIVar("Lumi","tree://Ntuples/QCD_Wjets_Powheg_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc3.GetProc("QCD Fill").AddIVar("finalWeight","tree://Ntuples/QCD_Wjets_Powheg_All_Years_ele_v23.5.root:CollectionTree_NOM");
  //dataproc3.GetProc("QCD Fill").AddIVar("passSR","tree://Ntuples/QCD_Wjets_Powheg_All_Years_ele_v23.5.root:CollectionTree_NOM");
...
QHNF_D* sr_qcd6d = new QHNF_D("QCD_7D", "QCD_7D", 7);
 ...
 l_arrayproc.AddQProc(&dataproc4);
  ...
  dataproc4.GetProc("NonW_Selector").AddIVar("dPhijj","tree://Ntuples/NonW_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc4.GetProc("NonW_Selector").AddIVar("dYjj","tree://Ntuples/NonW_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc4.GetProc("NonW_Selector").AddIVar("j1Pt","tree://Ntuples/NonW_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc4.GetProc("NonW_Selector").AddIVar("l1Pt","tree://Ntuples/NonW_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc4.GetProc("NonW_Selector").AddIVar("Mjj","tree://Ntuples/NonW_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc4.GetProc("NonW_Selector").AddIVar("Ptjj","tree://Ntuples/NonW_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc4.GetProc("NonW_Selector").AddIVar("passReco","tree://Ntuples/NonW_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc4.GetProc("NonW_Selector").AddIVar("cut","tree://Ntuples/NonW_All_Years_ele_v23.5.root:CollectionTree_NOM");
  //dataproc4.GetProc("NonW_Selector").AddIVar("passSR","tree://Ntuples/NonW_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc4.GetProc("NonW_Selector").AddIVar("nGapJets","tree://Ntuples/NonW_All_Years_ele_v23.5.root:CollectionTree_NOM");

  dataproc4.AddPSProc("NonW Fill","NonW Fill", MC_fill, NULL,kTRUE);
  //Get the TTree Branches
  dataproc4.GetProc("NonW Fill").AddIVar("dPhijj","tree://Ntuples/NonW_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc4.GetProc("NonW Fill").AddIVar("dYjj","tree://Ntuples/NonW_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc4.GetProc("NonW Fill").AddIVar("j1Pt","tree://Ntuples/NonW_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc4.GetProc("NonW Fill").AddIVar("l1Pt","tree://Ntuples/NonW_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc4.GetProc("NonW Fill").AddIVar("Mjj","tree://Ntuples/NonW_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc4.GetProc("NonW Fill").AddIVar("Ptjj","tree://Ntuples/NonW_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc4.GetProc("NonW Fill").AddIVar("l1Cent","tree://Ntuples/NonW_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc4.GetProc("NonW Fill").AddIVar("Lumi","tree://Ntuples/NonW_All_Years_ele_v23.5.root:CollectionTree_NOM");
  dataproc4.GetProc("NonW Fill").AddIVar("finalWeight","tree://Ntuples/NonW_All_Years_ele_v23.5.root:CollectionTree_NOM");
 // dataproc4.GetProc("NonW Fill").AddIVar("passSR","tree://Ntuples/NonW_All_Years_ele_v23.5.root:CollectionTree_NOM");
...
QHNF_D* sr_nonw6d = new QHNF_D("NonW_7D", "NonW_7D", 7);
 ...
 l_arrayproc.AddQProc(&dataproc5);
  ...
  dataproc5.GetProc("Multijet_Selector").AddIVar("dPhijj","tree://Ntuples/Multijet_All_ele_v23.5.root:CollectionTree_NOM");
  dataproc5.GetProc("Multijet_Selector").AddIVar("dYjj","tree://Ntuples/Multijet_All_ele_v23.5.root:CollectionTree_NOM");
  dataproc5.GetProc("Multijet_Selector").AddIVar("j1Pt","tree://Ntuples/Multijet_All_ele_v23.5.root:CollectionTree_NOM");
  dataproc5.GetProc("Multijet_Selector").AddIVar("l1Pt","tree://Ntuples/Multijet_All_ele_v23.5.root:CollectionTree_NOM");
  dataproc5.GetProc("Multijet_Selector").AddIVar("Mjj","tree://Ntuples/Multijet_All_ele_v23.5.root:CollectionTree_NOM");
  dataproc5.GetProc("Multijet_Selector").AddIVar("Ptjj","tree://Ntuples/Multijet_All_ele_v23.5.root:CollectionTree_NOM");
  dataproc5.GetProc("Multijet_Selector").AddIVar("passReco","tree://Ntuples/Multijet_All_ele_v23.5.root:CollectionTree_NOM");
  dataproc5.GetProc("Multijet_Selector").AddIVar("cut","tree://Ntuples/Multijet_All_ele_v23.5.root:CollectionTree_NOM");
  //dataproc5.GetProc("Multijet_Selector").AddIVar("passSR","tree://Ntuples/Multijet_All_ele_v23.5.root:CollectionTree_NOM");
  dataproc5.GetProc("Multijet_Selector").AddIVar("nGapJets","tree://Ntuples/Multijet_All_ele_v23.5.root:CollectionTree_NOM");

  dataproc5.AddPSProc("Multijet Fill","Multijet Fill", Multijet_fill, NULL,kTRUE);
  //Get the TTree Branches
  dataproc5.GetProc("Multijet Fill").AddIVar("dPhijj","tree://Ntuples/Multijet_All_ele_v23.5.root:CollectionTree_NOM");
  dataproc5.GetProc("Multijet Fill").AddIVar("dYjj","tree://Ntuples/Multijet_All_ele_v23.5.root:CollectionTree_NOM");
  dataproc5.GetProc("Multijet Fill").AddIVar("j1Pt","tree://Ntuples/Multijet_All_ele_v23.5.root:CollectionTree_NOM");
  dataproc5.GetProc("Multijet Fill").AddIVar("l1Pt","tree://Ntuples/Multijet_All_ele_v23.5.root:CollectionTree_NOM");
  dataproc5.GetProc("Multijet Fill").AddIVar("Mjj","tree://Ntuples/Multijet_All_ele_v23.5.root:CollectionTree_NOM");
  dataproc5.GetProc("Multijet Fill").AddIVar("Ptjj","tree://Ntuples/Multijet_All_ele_v23.5.root:CollectionTree_NOM");
  dataproc5.GetProc("Multijet Fill").AddIVar("l1Cent","tree://Ntuples/Multijet_All_ele_v23.5.root:CollectionTree_NOM");
  dataproc5.GetProc("Multijet Fill").AddIVar("Lumi","tree://Ntuples/Multijet_All_ele_v23.5.root:CollectionTree_NOM");
  dataproc5.GetProc("Multijet Fill").AddIVar("prw","tree://Ntuples/Multijet_All_ele_v23.5.root:CollectionTree_NOM");
  dataproc5.GetProc("Multijet Fill").AddIVar("mc_nFactor","tree://Ntuples/Multijet_All_ele_v23.5.root:CollectionTree_NOM");
  dataproc5.GetProc("Multijet Fill").AddIVar("recoWeight","tree://Ntuples/Multijet_All_ele_v23.5.root:CollectionTree_NOM");
  dataproc5.GetProc("Multijet Fill").AddIVar("SfsWeight","tree://Ntuples/Multijet_All_ele_v23.5.root:CollectionTree_NOM");
  dataproc5.GetProc("Multijet Fill").AddIVar("mc_w_init","tree://Ntuples/Multijet_All_ele_v23.5.root:CollectionTree_NOM");
 // dataproc5.GetProc("Multijet Fill").AddIVar("passSR","tree://Ntuples/Multijet_All_ele_v23.5.root:CollectionTree_NOM");
...
Bool_t QCD_Selector(QProcArgs &args){
 ...
 //finalWeight cuts (may not be necessary for the ele channel but this is a copy of the 
 //muon code and it does not change the results what so ever)
